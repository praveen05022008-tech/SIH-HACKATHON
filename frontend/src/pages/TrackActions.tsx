...
export const TrackActions: React.FC<TrackActionsProps> = ({ triggerNotification, triggerStateRefresh }) => {
  ...
  const fetchActionItems = async () => {
    ...
    try {
      ...
      // Add default mock items to ensure presentation matches prompt specifications exactly
      const demoActions: ActionItem[] = [
        {
          ...
          instructions: 'Isolate the affected area, stop nearby operations, identify the leakage source, and repair the damaged pipeline.',
          officerRemarks: 'Verify pressure indicators post-weld.',
          status: 'In Progress'
        },
        {
          id: 'ACT-1025',
          ...
          assignedPerson: 'Praveen P.',
          priority: 'MEDIUM',
          deadline: 'Tomorrow, 12:00 PM',
          createdDate: '29 Aug 2026',
          instructions: 'Conduct toolbox talk safety briefing regarding harness anchorage conformance.',
          officerRemarks: 'Log site supervisor signs.',
          status: 'Pending'
        },
        {
          id: 'ACT-1026',
          ...
          assignedTeam: 'Maintenance Team',
          assignedPerson: 'Hari S.',
          priority: 'HIGH',
          deadline: '29 Aug 2026, 4:00 PM',
          createdDate: '28 Aug 2026',
          instructions: 'Re-weld broken mounting brackets on the cooling basin platform guardrail.',
          officerRemarks: 'Safety harness tied off during repair.',
          status: 'Completed'
        },
        {
          id: 'ACT-1027',
          reportId: 'OBS-1027',
          issue: 'Gas Leakage',
          location: 'Refinery Unit 1',
          assignedTeam: 'Safety Team',
          assignedPerson: 'Ramesh K.',
          priority: 'CRITICAL',
          deadline: '28 Aug 2026, 10:00 AM',
          createdDate: '27 Aug 2026',
          instructions: 'Locate and seal the valve flange gasket bypass causing volatile emissions.',
          officerRemarks: 'Check Sniffer readings.',
          status: 'Overdue'
        }
      ];

      // Combine and filter duplicates
      const uniqueActions = [...demoActions];
      mappedActions.forEach(m => {
        if (!uniqueActions.some(u => u.id === m.id)) {
          uniqueActions.push(m);
        }
      });

      setActions(uniqueActions);
    } catch (err) {
      console.warn("API Offline, using presentation demo data.");
      setActions([
        {
          id: 'ACT-1024',
          reportId: 'OBS-1024',
