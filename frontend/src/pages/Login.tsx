...
import { Activity, ShieldAlert, KeyRound, Mail, ArrowRight, HardHat, ShieldCheck, BarChart3, Settings } from 'lucide-react';
...
export const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen flex font-sans antialiased text-slate-900 bg-slate-900">
      ...
      {/* Right Column: Clean Authentication Form (70% or 60% width) */}
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center gap-2 py-3.5 px-4 rounded-xl shadow-md text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 transition disabled:opacity-50"
            >
          ...
          {/* Quick Demo Persona Selector (NO EMOJIS, NO VIOLET) */}
              ...
              {demoAccounts.map((account) => {
                ...
                return (
                  <button
                    ...
                    className="p-3 text-left bg-white hover:bg-slate-100 border border-slate-200 hover:border-blue-500 rounded-xl transition shadow-2xs group"
                  >
          ...
          <div className="mt-8 text-center text-[10px] text-slate-400 font-semibold uppercase tracking-wider">
            RAKSHA AI SIF Intelligence Engine v2.4
          </div>
