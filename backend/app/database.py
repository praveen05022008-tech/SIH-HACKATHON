...
logger = logging.getLogger("raksha-ai.database")
...
def get_engine():
    ...
    try:
        if not is_sqlite:
            ...
            with engine.connect() as conn:
                logger.info("Successfully connected to RAKSHA AI Enterprise Database.")
            return engine
    ...
    logger.info("Initializing RAKSHA AI SQLite database connection.")
    engine = create_engine(
